    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeleteImages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Hospital = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Doctor = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Heartworm = table.Column<bool>(type: "bit", nullable: false),
                    Bordatella = table.Column<bool>(type: "bit", nullable: false),
                    Rabies = table.Column<bool>(type: "bit", nullable: false),
                    Da2ppv = table.Column<bool>(type: "bit", nullable: false),
                    Leptospirosis = table.Column<bool>(type: "bit", nullable: false),
                    InfluenzaH3N2 = table.Column<bool>(type: "bit", nullable: false),
                    InfluenzaH3N8 = table.Column<bool>(type: "bit", nullable: false),
                    FecalTest = table.Column<bool>(type: "bit", nullable: false),
                    OtherTests = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Timestamp = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true),
                    OwnedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
